        ...
        <div className={classes.netsContent}>
          ...
          <div className={classes.netsCards}>
            <ProductCard
              image={featuresImg1}
              name="АнтиПад"
              description="Сверхпрочная сетка с защитой от падений: 25-мм каркас + усиленные антивандальными креплениями. Устойчива к погодным условиям, вандализму и механическим повреждениям. Надёжно фиксируется, исключая падение, даже при сильном воздействии."
              price="от 900 руб м2"
              features={[
                "Высокая прочность",
                "Надёжность",
